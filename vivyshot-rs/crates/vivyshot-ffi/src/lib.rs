...
pub const VS_CAPTURE_STATUS_OK: i32 = 0;
pub const VS_CAPTURE_STATUS_NULL_POINTER: i32 = -1;
pub const VS_CAPTURE_STATUS_INVALID_ARGUMENT: i32 = -2;
pub const VS_CAPTURE_STATUS_BUFFER_TOO_SMALL: i32 = -3;
pub const VS_CAPTURE_STATUS_PERMISSION_DENIED: i32 = -100;
pub const VS_CAPTURE_STATUS_PERMISSION_NOT_DETERMINED: i32 = -101;
pub const VS_CAPTURE_STATUS_UNSUPPORTED_OS_VERSION: i32 = -102;
pub const VS_CAPTURE_STATUS_NO_DISPLAY_FOR_SELECTION: i32 = -103;
pub const VS_CAPTURE_STATUS_SELECTION_TOO_SMALL: i32 = -104;
pub const VS_CAPTURE_STATUS_UNSUPPORTED_CODEC: i32 = -105;
pub const VS_CAPTURE_STATUS_UNSUPPORTED_CONTAINER: i32 = -106;
pub const VS_CAPTURE_STATUS_STREAM_START_FAILED: i32 = -107;
pub const VS_CAPTURE_STATUS_STREAM_STOPPED_WITH_ERROR: i32 = -108;
pub const VS_CAPTURE_STATUS_RECORDING_OUTPUT_FAILED: i32 = -109;
pub const VS_CAPTURE_STATUS_NO_FRAMES_CAPTURED: i32 = -110;
pub const VS_CAPTURE_STATUS_OUTPUT_FILE_UNAVAILABLE: i32 = -111;
pub const VS_CAPTURE_STATUS_CANCELLED: i32 = -112;
pub const VS_CAPTURE_STATUS_INTERNAL_PLATFORM_ERROR: i32 = -113;
pub const VS_CAPTURE_STATUS_UNSUPPORTED_PLATFORM: i32 = -114;
pub const VS_CAPTURE_ENCODER_STANDARD_H264: u8 = 0;
pub const VS_CAPTURE_ENCODER_SMALLER_FILE_HEVC: u8 = 1;
pub const VS_CAPTURE_ENCODER_SOFTWARE_H264: u8 = 2;
pub const VS_CAPTURE_CODEC_H264: u8 = 0;
pub const VS_CAPTURE_CODEC_HEVC: u8 = 1;
pub const VS_CAPTURE_CONTAINER_MP4: u8 = 0;
pub const VS_CAPTURE_CONTAINER_MOV: u8 = 1;
pub const VS_CAPTURE_DEVICE_KIND_DISPLAY: u8 = 0;
pub const VS_CAPTURE_DEVICE_KIND_MICROPHONE: u8 = 1;
pub const VS_CAPTURE_DEVICE_CAPABILITY_DISPLAY_RECORDING: u32 = 1 << 0;
pub const VS_CAPTURE_DEVICE_CAPABILITY_REGION_RECORDING: u32 = 1 << 1;
pub const VS_CAPTURE_DEVICE_CAPABILITY_SCREENSHOT_CAPTURE: u32 = 1 << 2;
pub const VS_CAPTURE_DEVICE_CAPABILITY_MICROPHONE_AUDIO: u32 = 1 << 3;
pub const VS_CAPTURE_PIXEL_FORMAT_BGRA8_PREMULTIPLIED_FIRST: u8 = 0;
