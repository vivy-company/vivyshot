...
This repository includes third-party Rust crates through `vivyshot-rs/Cargo.lock`.

The list below is generated from `cargo metadata` and reflects dependency license expressions at the time of generation.
...
| `autocfg` | `1.5.0` | `Apache-2.0 OR MIT` | https://crates.io/crates/autocfg |
...
| `bitflags` | `2.11.0` | `MIT OR Apache-2.0` | https://crates.io/crates/bitflags |
...
| `fastrand` | `2.3.0` | `Apache-2.0 OR MIT` | https://crates.io/crates/fastrand |
...
| `font8x8` | `0.3.1` | `MIT` | https://crates.io/crates/font8x8 |
| `fontdue` | `0.9.3` | `MIT OR Apache-2.0 OR Zlib` | https://crates.io/crates/fontdue |
...
| `image` | `0.25.9` | `MIT OR Apache-2.0` | https://crates.io/crates/image |
| `indexmap` | `2.13.0` | `Apache-2.0 OR MIT` | https://crates.io/crates/indexmap |
| `itoa` | `1.0.17` | `MIT OR Apache-2.0` | https://crates.io/crates/itoa |
| `leb128fmt` | `0.1.0` | `MIT OR Apache-2.0` | https://crates.io/crates/leb128fmt |
| `libc` | `0.2.182` | `MIT OR Apache-2.0` | https://crates.io/crates/libc |
| `linux-raw-sys` | `0.12.1` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | https://crates.io/crates/linux-raw-sys |
| `log` | `0.4.29` | `MIT OR Apache-2.0` | https://crates.io/crates/log |
| `memchr` | `2.8.0` | `Unlicense OR MIT` | https://crates.io/crates/memchr |
| `miniz_oxide` | `0.8.9` | `MIT OR Zlib OR Apache-2.0` | https://crates.io/crates/miniz_oxide |
| `moxcms` | `0.7.11` | `BSD-3-Clause OR Apache-2.0` | https://crates.io/crates/moxcms |
| `num-traits` | `0.2.19` | `MIT OR Apache-2.0` | https://crates.io/crates/num-traits |
| `once_cell` | `1.21.3` | `MIT OR Apache-2.0` | https://crates.io/crates/once_cell |
...
| `proptest` | `1.10.0` | `MIT OR Apache-2.0` | https://crates.io/crates/proptest |
| `pxfm` | `0.1.28` | `BSD-3-Clause OR Apache-2.0` | https://crates.io/crates/pxfm |
| `quick-error` | `1.2.3` | `MIT/Apache-2.0` | https://crates.io/crates/quick-error |
| `quote` | `1.0.44` | `MIT OR Apache-2.0` | https://crates.io/crates/quote |
...
| `rand` | `0.9.2` | `MIT OR Apache-2.0` | https://crates.io/crates/rand |
...
| `rand_xorshift` | `0.4.0` | `MIT OR Apache-2.0` | https://crates.io/crates/rand_xorshift |
...
| `semver` | `1.0.27` | `MIT OR Apache-2.0` | https://crates.io/crates/semver |
...
| `serde_json` | `1.0.149` | `MIT OR Apache-2.0` | https://crates.io/crates/serde_json |
| `simd-adler32` | `0.3.8` | `MIT` | https://crates.io/crates/simd-adler32 |
| `syn` | `2.0.117` | `MIT OR Apache-2.0` | https://crates.io/crates/syn |
| `tempfile` | `3.26.0` | `MIT OR Apache-2.0` | https://crates.io/crates/tempfile |
| `ttf-parser` | `0.21.1` | `MIT OR Apache-2.0` | https://crates.io/crates/ttf-parser |
| `unarray` | `0.1.4` | `MIT OR Apache-2.0` | https://crates.io/crates/unarray |
...
| `wasip2` | `1.0.2+wasi-0.2.9` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | https://crates.io/crates/wasip2 |
...
| `zerocopy` | `0.8.40` | `BSD-2-Clause OR Apache-2.0 OR MIT` | https://crates.io/crates/zerocopy |
| `zerocopy-derive` | `0.8.40` | `BSD-2-Clause OR Apache-2.0 OR MIT` | https://crates.io/crates/zerocopy-derive |
| `zmij` | `1.0.21` | `MIT` | https://crates.io/crates/zmij |
| `zune-core` | `0.5.1` | `MIT OR Apache-2.0 OR Zlib` | https://crates.io/crates/zune-core |
| `zune-jpeg` | `0.5.12` | `MIT OR Apache-2.0 OR Zlib` | https://crates.io/crates/zune-jpeg |
