...
extension AnnotationCanvasView {
  ...
  func deleteSelectedAnnotation() -> Bool {
    ...
    guard let updatedImage = delegate?.annotationCanvasView(self, deleteAnnotationAt: selectedAnnotationIndex) else {
      return false
    }
  ...
  func selectAnnotation(atImagePoint imagePoint: CGPoint) {
    guard let hit = delegate?.annotationCanvasView(self, hitTestAnnotationAt: imagePoint),
  ...
  func hitAnnotation(at viewPoint: CGPoint) -> (AnnotationInfo, CGPoint, CGRect)? {
