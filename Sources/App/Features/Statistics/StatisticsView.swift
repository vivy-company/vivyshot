...
final class StatisticsViewModel: ObservableObject {
  ...
  func refresh() async {
    ...
    guard let dashboardData = await StatisticsStore.shared.dashboardData() else {
...
private struct StatisticsRootView: View {
  ...
  private func recentMetricValues(dayCount: Int = 10, value: (StatsDailyBucket) -> Double) -> [Double] {
    let calendar = Calendar.autoupdatingCurrent
